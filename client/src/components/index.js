    ...
    return(
      <form className="form p-2" onSubmit={onSubmit}>
        <div className="form_body d-flex justify-content-between flex-column">
          <div>
              <input className="form-control mb-2"  type="text" name="name" ref={ref} onChange={onChange} placeholder="NFT Name"/>
              <input className="form-control mb-2"  type="number" name="price" ref={ref} onChange={onChange} min="0.0001" step="0.0001" placeholder="NFT Price in ETH"/>
