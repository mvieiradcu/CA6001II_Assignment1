...
const Navbar = ({ account, balance: contractBalance, itemsSold, nftCount }) => {
  ...
  <nav className="navbar navbar-expand-lg navbar-light bg-light">
    <div className="container-fluid">
      ...
      <ul className='contract-info list-inline mt-3 p-2'>
        <li className="list-inline-item"> <span className='bold'>Total NFT</span> : {nftCount} /</li>
        <li className="list-inline-item"> <span className='bold'>Items Sold</span> : {itemsSold} ETH</li>
      </ul>
